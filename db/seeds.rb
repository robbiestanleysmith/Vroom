...
bmw = Car.create!(title: "Classic BMW", make: "BMW", model: "2002 tii", price_per_day: 170, location: "Guildford, Surrey", mileage: 75670, description: "The BMW 2002 is a car produced by the German car company between 1971 and 1975.
  ...
  The BMW Serie 02 had a good commercial success, so the German company decided to improve the car by presenting the 2002 version with a 1990 cc engine, a car with a clearly sporty character." user: user1)
...
alfaromeo = Car.create!(title: "Gorgeous pristine condition Alfa Romeo Duetto from 1957", make: "Alfa Romeo", model: "Duetto", price_per_day: 335, location: "Winchester, Wiltshire", mileage: 43124, description: "The Alfa Romeo Duetto is one of the most famous cars of the Italian manufacturer, produced from 1966 to 1993.
  The cuttlefish bone version, launched on the market starting in 1966, is one of the most beautiful and popular models.
  The very rounded shape of the front and rear, connected by convex sides, is reminiscent of a cuttlefish bone. The engine was that of the 1600 CC and 109 HP Alfa Romeo Giulia Sprint GT, equipped with two Weber double-barrel carburettors." user: user2)
...
austin = Car.create!(title: "Stylish vintage Austin Healey 100, drives like a dream!", make: "Austin", model: "Healey", price_per_day: 275, location: "Southampton, Hampshire", mileage: 98325, description: "The Austin-Healey 100 is a car produced by BMC between 1953 and 1958 and sold under the Austin-Healey brand.
  ...
  In 1956 the 100-6 was presented, with a new 6-cylinder in-line engine of 2639 cm³ and 102 HP. " user: user3)
...
chev = Car.create!(title: "Chevrolet Corvette C1 in amazing condition!", make: "Chevrolet", model: "Corvette C1", price_per_day: 500, location: "Kensington, London", mileage: 56834, description: "The Chevrolet Corvette C1 represents the first generation of sports cars produced by the American car manufacturer Chevrolet from 1953 to 1962.
  To reduce production costs, it was decided to use standard mechanical components and the design of the chassis and suspension of previous vehicles. During the years of its production there were many changes and updates made to the initial design. The 1958 model introduced the four front headlights and the prominent grilles with numerous chrome plating. The interior and the instruments were updated, placing a tachometer directly in front of the driver. For the 1958 model, a 8000 rpm speedometer was used with 270 hp and 290 hp engines." user: user3)
...
The SP250 has a luxurious and refined cockpit (the dashboard, seats, and doors panels are up-holstered in leather, while the floor was covered with fine wool." user: user4)
